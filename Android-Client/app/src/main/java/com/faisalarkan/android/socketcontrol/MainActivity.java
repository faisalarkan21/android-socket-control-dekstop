...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.spinner_boot)
    Spinner mSpinnerBoot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String program[] = {"Visual Studio Code", "Sublime Text", "Tilix", "Google Chrome"};

        ArrayAdapter<String> adapterProgram = new ArrayAdapter<String>
                (this, android.R.layout.select_dialog_item, program);

        mSpinner.setAdapter(adapterProgram);


        String boot[] = {"Restart", "Shutdown"};

        ArrayAdapter<String> adapterBoot = new ArrayAdapter<String>
                (this, android.R.layout.select_dialog_item, boot);

        mSpinnerBoot.setAdapter(adapterBoot);
    ...
    public void executeProgram() {
        ...
        if (isConnected && out != null) {
            out.println(mSpinner.getSelectedItem().toString());
        }


    }

    public void executeBoot() {
        if (isConnected && out != null) {
            out.println(mSpinnerBoot.getSelectedItem().toString());
        }
    }
